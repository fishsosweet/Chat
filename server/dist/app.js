...
exports.app.get(`${env_1.env.API_PREFIX}/auth/users/:userId`, auth_middleware_1.authMiddleware, (0, async_handler_1.asyncHandler)(auth_controller_1.getUserProfileController));
exports.app.patch(`${env_1.env.API_PREFIX}/auth/profile`, auth_middleware_1.authMiddleware, (0, validate_request_middleware_1.validateRequest)(auth_schema_1.updateProfileSchema), (0, async_handler_1.asyncHandler)(auth_controller_1.updateProfileController));
